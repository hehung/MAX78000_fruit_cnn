...
/*
 * This header file was automatically generated for the ai8x-fruit network from a template.
...
/*
  SUMMARY OF OPS
  Hardware: 17,416,704 ops (17,235,328 macc; 152,704 comp; 28,672 add; 0 mul; 0 bitwise)
    ...
    Layer 13: 1,408 ops (1,408 macc; 0 comp; 0 add; 0 mul; 0 bitwise)

  RESOURCE USAGE
  Weight memory: 80,608 bytes out of 442,368 bytes total (18%)
  Bias memory:   11 bytes out of 2,048 bytes total (1%)
*/
